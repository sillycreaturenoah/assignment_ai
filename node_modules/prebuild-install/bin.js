...
const rc = require('prebuild-install/rc')(pkg)
const log = require('prebuild-install/log')(rc, process.env)
const download = require('prebuild-install/download')
const asset = require('prebuild-install/asset')
const util = require('prebuild-install/util')

const prebuildClientVersion = require('prebuild-install/package.json').version
if (rc.version) {
